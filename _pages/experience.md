...
* <details>
    <summary>
      2026.02 – present<span class="expand-icon"></span>, <strong>Participant</strong>, <i>System Equilibrium, Incentive Mechanism, and Facility Allocation for Large-Scale Vehicle-to-Grid Interaction</i>, National Natural Science Foundation of China (General Program). PI: Prof. Chi Xie. (Proposal under preparation)
    </summary>
    <div style="margin-top: 5px; padding: 10px; background-color: #f9f9f9; border-left: 3px solid #ccc; font-size: 0.9em;">
      Responsible for drafting the comprehensive literature review section of the grant proposal.
    </div>
  </details>
